...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    .setAuthor({name: "BurakCanYT - Bot İstatistik!", iconURL: client.user.avatarURL()})
    ...
    .addFields({name: "Seslide Olduğum Sunucu Sayısı:", value: `${client?.voice?.adapters?.size || 0}`, inline: true})
